...
from utils import last_two_thursdays, get_symbol, get_token, get_ltp, get_nifty_price, nearest_price
...
def main():
    ...
    if day in last_two_thursdays(year, month):
        print('Today is not the last or second-to-last Thursday of the month!')
        return
